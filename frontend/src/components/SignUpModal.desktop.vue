<template>
  ...
  <v-layout row justify-center>
    <v-dialog v-model="signupDialog" persistent max-width="500px">
      ...
      slot="activator"
      text="sign up"
      style="overflow:hidden; background-color: #051760; color: white; text-shadow: 1px 1px 2px black; padding: 10px; margin: 10px"
      light>
      Sign Up
      </v-btn>
      <v-card>
        ...
        <v-card-actions>
          <v-spacer></v-spacer>
          <v-btn @click.prevent="toggleLogin"><a href="#">Already have an account?</a></v-btn>
          <v-btn
          color="blue darken-1"
          app
